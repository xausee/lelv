 ...
 * 最后修正：2009-12-18
 **/
var IMAGESPATH = '../public/pop/images/'; //图片路径配置
...
Dialog.prototype.create = function() {
    ...
    var html = '<table id="_DialogTable_' + this.ID + '" width="' + (this.Width + 26) + '" cellspacing="0" cellpadding="0" border="0" onselectstart="return false;" style="-moz-user-select: none; font-size:12px; line-height:1.4;">\
             <td valign="top" align="center"><div id="_Container_' + this.ID + '" style="position: relative; width: ' + this.Width + 'px; height: ' + this.Height + 'px;">\
                <div align="right" style="position: absolute; height: 50px; width: 100%; display: block; background-color:#fff; opacity: 1.0;">\
                   <h3><span id="_ButtonCancel_0" style="border:0;cursor:pointer;background-color:#FFFFFF;" onclick="Dialog.getInstance(\'' + this.ID + '\').close();" >&nbsp;&nbsp;&nbsp;&nbsp;X&nbsp;&nbsp;&nbsp;&nbsp;</span></h3>\
                </div>\
    ' + (function(obj) {
